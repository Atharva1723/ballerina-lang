...
public class VariableVisibilityTest extends BaseTestCase {
  ...
  public void initialVariableVisibilityTest() throws BallerinaTestException {
    ...
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 123));
  ...
  @Test(
      description =
          "Variable visibility test in the middle of the main() method for a new variable",
      enabled = false)
  public void newVariableVisibilityTest() throws BallerinaTestException {
    ...
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 245));
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 316));
    debugTestRunner.initDebugSession(DebugUtils.DebuggeeExecutionKind.RUN);
    debugHitInfo = debugTestRunner.waitForDebugHit(25000);
    localVariables =
        debugTestRunner.fetchVariables(
            debugHitInfo.getRight(), DebugTestRunner.VariableScope.LOCAL);
    ...
    debugTestRunner.resumeProgram(
        debugHitInfo.getRight(), DebugTestRunner.DebugResumeKind.STEP_OVER);
    ...
    debugTestRunner.resumeProgram(
        debugHitInfo.getRight(), DebugTestRunner.DebugResumeKind.NEXT_BREAKPOINT);
  ...
  public void controlFlowVariableVisibilityTest() throws BallerinaTestException {
    ...
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 266));
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 270));
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 277));
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 284));
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 293));
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 299));
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 306));
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 322));
    // Todo - enable after fixing https://github.com/ballerina-platform/ballerina-lang/issues/27738
    // debugTestRunner.addBreakPoint(new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath,
    // 266));
    ...
    // debugTestRunner.resumeProgram(debugHitInfo.getRight(),
    // DebugTestRunner.DebugResumeKind.NEXT_BREAKPOINT);
    // debugHitInfo = debugTestRunner.waitForDebugHit(10000);
    // localVariables = debugTestRunner.fetchVariables(debugHitInfo.getRight(),
    // DebugTestRunner.VariableScope
    // .LOCAL);
  ...
  public void globalVariableVisibilityTest() throws BallerinaTestException {
    ...
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 352));
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 327));
    debugTestRunner.initDebugSession(DebugUtils.DebuggeeExecutionKind.RUN);
    debugHitInfo = debugTestRunner.waitForDebugHit(25000);
    globalVariables = debugTestRunner.fetchVariables(debugHitInfo.getRight(), VariableScope.GLOBAL);
    ...
    //        debugTestRunner.assertVariable(globalVariables, "nameMap",
    // "(debug_test_resources/variable_tests" +
    ...
    debugTestRunner.assertVariable(
        globalVariables, " /:@[`{~π_IL", "\"IL with global var\"", "string");
    debugTestRunner.assertVariable(globalVariables, "port", "9090", "int");
  }

  @Test(
      description =
          "Variable visibility test for local variables at the last line of main() method")
  public void localVariableVisibilityTest() throws BallerinaTestException {
    ...
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 327));
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 360));
    debugTestRunner.initDebugSession(DebugUtils.DebuggeeExecutionKind.RUN);
    debugHitInfo = debugTestRunner.waitForDebugHit(25000);
    localVariables = debugTestRunner.fetchVariables(debugHitInfo.getRight(), VariableScope.LOCAL);
    globalVariables = debugTestRunner.fetchVariables(debugHitInfo.getRight(), VariableScope.GLOBAL);
    ...
    // A closure is an inner anonymous function that has visibility to the scope of its enclosing
    // environment.
    // It can access its own scope, its enclosing environment’s scope, and variables defined in the
    // global scope.
    ...
    debugTestRunner.assertVariable(
        localVariables, "tupleVar", "tuple[int,string] (size = 2)", "tuple");
    ...
    debugTestRunner.assertVariable(
        localVariables, "recordVar", " /:@[`{~π_123_ƮέŞŢ_Student", "record");
    ...
    debugTestRunner.assertVariable(
        localVariables, "anonRecord", "record {| string city; string country; |}", "record");
    ...
    debugTestRunner.assertVariable(
        localVariables,
        "anonFunctionVar",
        "isolated function (string,string) returns (string)",
        "function");
    ...
    debugTestRunner.assertVariable(
        localVariables, "objectVar", "Person_\\ /<>:@[`{~π_ƮέŞŢ", "object");

    debugTestRunner.assertVariable(
        localVariables, "anonObjectVar", "Person_\\ /<>:@[`{~π_ƮέŞŢ", "object");
    ...
    debugTestRunner.assertVariable(
        localVariables, "tableWithKeyVar", "table<Employee> (entries = 3)", "table");

    // table without key variable visibility test
    debugTestRunner.assertVariable(
        localVariables, "tableWithoutKeyVar", "table<Employee> (entries = 3)", "table");

    // stream variable visibility test
    debugTestRunner.assertVariable(
        localVariables, "oddNumberStream", "stream<int, error?>", "stream");

    // variables with quoted identifiers visibility test
    debugTestRunner.assertVariable(
        localVariables, " /:@[`{~π_var", "\"IL with special characters in var\"", "string");
    debugTestRunner.assertVariable(
        localVariables, "üňĩćőđę_var", "\"IL with unicode characters in var\"", "string");
    debugTestRunner.assertVariable(
        localVariables, "ĠĿŐΒȂɭ_ /:@[`{~π_json", "json (size = 0)", "json");
  ...
  @Test(
      enabled = false,
      description =
          "Child variable visibility test for local variables at the last line of main"
              + "() method")
  public void localVariableChildrenVisibilityTest() throws BallerinaTestException {
    ...
    Map<String, Variable> xmlChildVariables =
        debugTestRunner.fetchChildVariables(localVariables.get("xmlVar"));
    debugTestRunner.assertVariable(
        xmlChildVariables, "attributes", "XMLAttributeMap (size = 16)", "map");
    ...
    debugTestRunner.assertVariable(
        xmlGrandChildrenVariables, "children", "XMLSequence (size = 1)", "xml");

    // array child variable visibility test
    Map<String, Variable> arrayChildVariables =
        debugTestRunner.fetchChildVariables(localVariables.get("arrayVar"));
    ...
    Map<String, Variable> byteChildVars =
        debugTestRunner.fetchChildVariables(localVariables.get("byteArrayVar"));
    ...
    Map<String, Variable> tupleChildVariables =
        debugTestRunner.fetchChildVariables(localVariables.get("tupleVar"));
    ...
    Map<String, Variable> mapChildVariables =
        debugTestRunner.fetchChildVariables(localVariables.get("mapVar"));
    ...
    debugTestRunner.assertVariable(
        studentRecordChildVariables, "1st_name", "\"John Doe\"", "string");
    ...
    debugTestRunner.assertVariable(
        studentRecordChildVariables, "course", "\"ballerina\"", "string");
    ...
    Map<String, Variable> errorChildVariables =
        debugTestRunner.fetchChildVariables(localVariables.get("errorVar"));
    ...
    debugTestRunner.assertVariable(
        errorDetailsChildVariables, "message", "\"Simple error occurred\"", "string");
    ...
    debugTestRunner.assertVariable(
        personObjectChildVariables, "address", "\"No 20, Palm grove\"", "string");
    debugTestRunner.assertVariable(personObjectChildVariables, "parent", "()", "nil");
    debugTestRunner.assertVariable(
        personObjectChildVariables, "email", "\"default@abc.com\"", "string");
    ...
    debugTestRunner.assertVariable(
        anonObjectChildVariables, "address", "\"No 20, Palm grove\"", "string");
    debugTestRunner.assertVariable(anonObjectChildVariables, "parent", "()", "nil");
    debugTestRunner.assertVariable(
        anonObjectChildVariables, "email", "\"default@abc.com\"", "string");
    ...
    // debugTestRunner.assertVariable(anonPersonAddressChildVariables[0], "city", "Colombo",
    // "string");
    // debugTestRunner.assertVariable(anonPersonAddressChildVariables[1], "country", "Sri Lanka",
    // "string");

    // json child variable visibility test
    Map<String, Variable> jsonChildVariables =
        debugTestRunner.fetchChildVariables(localVariables.get("jsonVar"));
  ...
  public void objectVariableVisibilityTest() throws BallerinaTestException {
    ...
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 21));
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 25));
    debugTestRunner.initDebugSession(DebugUtils.DebuggeeExecutionKind.RUN);
    Pair<BallerinaTestDebugPoint, StoppedEventArguments> debugHitInfo =
        debugTestRunner.waitForDebugHit(25000);
    ...
    Map<String, Variable> selfChildVariables =
        debugTestRunner.fetchChildVariables(localVariables.get("self"));
  ...
  // Need to be enabled after fixing
  // https://github.com/ballerina-platform/ballerina-lang/issues/43636
  ...
  public void workerVariableVisibilityTest() throws BallerinaTestException {
    ...
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 22));
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 28));
    debugTestRunner.initDebugSession(DebugUtils.DebuggeeExecutionKind.RUN);
    Pair<BallerinaTestDebugPoint, StoppedEventArguments> debugHitInfo =
        debugTestRunner.waitForDebugHit(60000);
    if (debugHitInfo.getKey().getLine() == 22) {
      ...
      // variable visibility test for workers outside fork (workers are visible outside fork() as
      // futures).
      debugTestRunner.resumeProgram(
          debugHitInfo.getRight(), DebugTestRunner.DebugResumeKind.NEXT_BREAKPOINT);
  ...
  public void bindingPatternVariableVisibilityTest() throws BallerinaTestException {
    ...
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 35));
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 40));
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 43));
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 46));
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 49));
    debugTestRunner.addBreakPoint(
        new BallerinaTestDebugPoint(debugTestRunner.testEntryFilePath, 80));
    ...
    debugTestRunner.resumeProgram(
        debugHitInfo.getRight(), DebugTestRunner.DebugResumeKind.NEXT_BREAKPOINT);
    debugHitInfo = debugTestRunner.waitForDebugHit(10000);
    // TODO: enable after fixing runtime issue
    // https://github.com/ballerina-platform/ballerina-lang/issues/43623
    //        localVariables = debugTestRunner.fetchVariables(debugHitInfo.getRight(),
    ...
    //        localVariables = debugTestRunner.fetchVariables(debugHitInfo.getRight(),
    // DebugTestRunner.VariableScope.LOCAL);
    //        debugTestRunner.assertVariable(localVariables, "cause", "\"Database Error\"",
    // "error");
    //        debugTestRunner.assertVariable(localVariables, "code", "20", "int");
    //        debugTestRunner.assertVariable(localVariables, "reason", "\"deadlock condition\"",
    // "string");
